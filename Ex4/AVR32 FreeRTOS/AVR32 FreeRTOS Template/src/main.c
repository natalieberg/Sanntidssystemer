...
int main()
{
	...
	//AssignmentA
	//xTaskCreate( vTaskA, (signed char * ) "TASK_A", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
	//xTaskCreate( vTaskB, (signed char * ) "TASK_B", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
	
	//Assignment B
	//xTaskCreate( vTestA, (signed char * ) "TESTA", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	//xTaskCreate( vTestB, (signed char * ) "TESTB", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	//xTaskCreate( vTestC, (signed char * ) "TESTC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	//xTaskCreate( vCpuWork, (signed char * ) "CPUWORK", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
